...
```
Error: locator.hover: Error: strict mode violation: locator('.cart-label') resolved to 2 elements:
    1) <span class="cart-label">Shopping cart</span> aka getByRole('link', { name: 'Shopping cart (0)' })
    2) <span class="cart-label">Wishlist</span> aka getByRole('link', { name: 'Wishlist (0)' })

Call log:
  - waiting for locator('.cart-label')
                  ...
                  - generic [ref=e165]:
                    - heading "Computing and Internet" [level=2] [ref=e166]:
                      - link "Computing and Internet" [ref=e167] [cursor=pointer]:
                        - /url: /computing-and-internet
                    - generic "2539 review(s)" [ref=e168]
                    - generic [ref=e171]:
                      - generic [ref=e172]:
